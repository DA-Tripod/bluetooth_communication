...
void loop() {
  ...
  unsigned int result = (uS/US_ROUNDTRIP_CM);
  
 // Serial.print("Ping: ");
  bluetooth.println(result); // Convert ping time to distance in cm and print result (0 = outside set distance range)
  delay(30);
  bluetooth.print(';');
  bluetooth.println(uS_2 / US_ROUNDTRIP_CM); // Convert ping time to distance in cm and print result (0 = outside set distance range)
  delay(30);
  bluetooth.print(';');
